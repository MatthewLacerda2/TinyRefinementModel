...
Runs the exact scoring core from instruments.yardstick.yardstick over the real GPT-2-small
...
never runs GPT-2). Install into a scratch venv when re-calibrating:
    ...
    PYTHONPATH=. python -m instruments.yardstick.calibrate_gpt2 [--limit 500]
