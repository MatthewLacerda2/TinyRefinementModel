...
Run against the latest (or a given) checkpoint when the GPU is free:
    PYTHONPATH=. python -m instruments.dump_transcripts [--max-new-tokens 128]
"""
...
# jax (via trm.runtime.restore), and the memory-fraction var has no effect once jax is
...
from trm.runtime.checkpoints import discover_latest_checkpoint_run  # noqa: E402
from trm.config import TOKENIZER_NAME  # noqa: E402
from trm.runtime.restore import restore_model  # noqa: E402
