...
Two probe families:
  ...
  memorization (memorize, --mem-pairs N) — NO rule exists (fixed random
    ...
    venv/bin/python -m experiments.depth.ablation_harness --task parity --depths 1,2,4,8
    venv/bin/python -m experiments.depth.ablation_harness --task memorize --mem-pairs 4096 --arch vanilla
"""
