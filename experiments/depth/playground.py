...
Usage:
    PYTHONPATH=. python -m experiments.depth.playground --prompt "The meaning of life is"
    PYTHONPATH=. python -m experiments.depth.playground            # interactive loop
...
# E402 below is deliberate and load-bearing: trm.config reads MODEL_ARCH,
# TIME_SIGNAL and friends from the environment at import time, so .env has to be
# loaded before it. Hoisting these would make a .env-selected arch silently ignored.
from trm.config import MAX_SEQ_LEN, PAD_TOKEN_ID, TOKENIZER_NAME  # noqa: E402
from trm.infer import _temperature_truncate  # noqa: E402
from trm.runtime.restore import restore_refiner  # noqa: E402
