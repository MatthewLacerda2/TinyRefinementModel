...
decomposes exactly into the K sub-results the slots are graded on.
    ...
    python -m experiments.scratchpad.harness --arms serial,parallel,depthonly --seeds 0,1,2
    python -m experiments.scratchpad.harness --arms overwrite,serial --seeds 0,1,2 --K 4
    python -m experiments.scratchpad.harness --arms budget1,budget2,unlimited --seeds 0,1,2 --K 5
"""
